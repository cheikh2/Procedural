function clientType() {
    let status = document.getElementById("TypeClient");

    if (status.value == "nonSalarie") {
    ...
    } else if (status.value == "salarie") {
        document.getElementById("salaire").style.display = "";
        document.getElementById("labS").style.display = "";
            ...
            if (myTelephone.value.trim() == "") {
                ...
                if (myProfession.value.trim() == "") {
                    ...
                    if (myCni.value.trim() == "") {
                        ...
                        //         e.preventDefault();
                        //     } else if (
                        //         (mySalaire.value >= 25000 && mySalaire.value <= 2000000) == false
                        //     ) {
